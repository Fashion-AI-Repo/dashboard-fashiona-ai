...
const ECommerceProductsSelect = () => {
  return (
    <div className="w-full h-[1826px] relative bg-white overflow-hidden flex flex-col items-start justify-start pt-5 px-0 pb-40 box-border gap-[101.9px] leading-[normal] tracking-[normal] text-left text-lg text-white font-inter mq450:gap-[25px] mq750:gap-[51px] mq1050:h-auto">
      <main className="w-[1402.5px] h-[1646px] flex flex-col items-end justify-start pt-0 pb-[1564.4px] pl-0 pr-5 box-border gap-[29px] max-w-full lg:pb-[661px] lg:box-border mq750:pb-[430px] mq750:box-border mq1050:h-auto">
        <FrameComponent />
        <section className="self-stretch flex flex-row items-start justify-start gap-[13.3px] max-w-full text-left text-5xl text-coral-200 font-inter mq1050:pl-[13.3px] mq1050:pr-[13.3px] mq1050:box-border">
          <div className="flex-1 flex flex-row items-start justify-start gap-5 max-w-[calc(100%_-_294px)] mq1050:flex-wrap mq1050:max-w-full">
            <div className="h-[1369.4px] flex flex-col items-start justify-start gap-[19.9px] min-w-[290px] mq1050:flex-1">
              <div className="flex flex-row items-start justify-start py-0 px-[58px]">
                <div className="flex-1 flex flex-col items-start justify-start gap-2.5">
                  <a className="[text-decoration:none] relative uppercase font-semibold text-[inherit] mq450:text-lgi">
                    women
                  </a>
                  <div className="self-stretch relative uppercase text-gray-100 mq450:text-lgi">
                    men
                  </div>
                </div>
              </div>
              <div className="self-stretch flex-1 flex flex-row items-start justify-end pt-[30.5px] px-[27px] pb-[30px] relative text-lg text-gray-100 lg:pt-5 lg:pb-5 lg:box-border">
                <div className="h-full w-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px] rounded-tl-none rounded-tr-xl rounded-br-xl rounded-bl-none bg-gray-600" />
                <div className="h-[1016px] w-[205px] overflow-hidden shrink-0 flex flex-col items-start justify-start pt-[49px] px-0 pb-[9px] box-border gap-[29.8px] z-[1] lg:pt-8 lg:pb-5 lg:box-border mq750:pt-[21px] mq750:box-border">
            ...
            <div className="flex-1 flex flex-col items-start justify-start pt-[11px] px-0 pb-0 box-border min-w-[506px] max-w-full text-lg text-white mq750:min-w-full">
              <div className="self-stretch flex flex-col items-start justify-start gap-5 max-w-full">
                <div className="self-stretch flex flex-row items-end justify-start gap-5 text-gray-400 mq750:flex-wrap">
                  ...
                  <div className="flex-1 flex flex-col items-end justify-start gap-[42.9px] min-w-[187px] mq450:gap-[21px]">
                    <div className="self-stretch flex flex-row items-start justify-start py-0 pl-[26px] pr-0 gap-5">
                      <FormControl
                        className="h-[22px] w-[74.4px] font-inter text-lg text-gray-400"
                        variant="standard"
                        sx={{
                          borderTopWidth: "0px",
                      ...
                      <div className="flex flex-row items-start justify-start gap-2.5">
                        <a className="[text-decoration:none] relative capitalize text-[inherit] inline-block min-w-[114px] shrink-0">
                          Recomended
                        </a>
                        <div className="flex flex-col items-start justify-start pt-[5.7px] px-0 pb-0 shrink-0">
                          <Image
                            className="w-[6.8px] h-[10.5px] relative shrink-0"
                            loading="lazy"
                            width={7}
                            height={11}
                            alt=""
                    ...
                    <div className="self-stretch flex flex-row items-start justify-end py-0 pl-0 pr-1.5 text-white">
                      <div className="flex-1 flex flex-col items-start justify-start gap-5">
                        <div className="self-stretch rounded-3xs overflow-hidden flex flex-row items-start justify-start pt-[0.4px] pb-0 pl-0.5 pr-0 bg-[url('/0476126dc3be4080824b7d3ea6abb41e-ghostjpg2@3x.png')] bg-cover bg-no-repeat bg-[top]">
                          <div className="rounded-tl-3xs rounded-tr-none rounded-br-3xs rounded-bl-none bg-gray-400 hidden flex-row items-center justify-center py-1.5 px-5">
                            <b className="relative capitalize">100$</b>
                          </div>
      ...
      <div className="bg-coral-200 flex flex-row items-start justify-start pt-[18.5px] pb-[18.6px] pl-[591px] pr-[567px] box-border max-w-full mq450:pl-5 mq450:pr-5 mq450:box-border mq750:pl-[295px] mq750:pr-[283px] mq750:box-border">
        <footer className="h-[59.1px] w-[1440px] relative bg-coral-200 hidden max-w-full" />
